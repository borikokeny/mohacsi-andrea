...
export default function AboutPage() {
  ...
  return (
    <main className="bg-[#ffffff] text-[#2a2a2a]">
      {/* HERO */}
            <section className="relative h-[40vh] min-h-[600px] overflow-hidden">
  <img
    src={Portre_cut}
    alt="Mohácsi Andrea"
  ...
  {/* content */}
  <div className="relative z-10 max-w-6xl mx-auto h-full flex items-start mt-16 me-3 justify-end px-6">
    
    <div className="w-full max-w-[610px] bg-[#f8f6f2]/75 backdrop-blur-[2px] px-10 py-10 md:px-14 md:py-10 rounded-sm text-left">
      
      <p className="uppercase tracking-[0.22em] text-[11px] md:text-xs text-[#32302f] mb-3 leading-relaxed">
        Integratív szemléletű mentálhigiénés szakember
      </p>

      <h1 className="text-4xl md:text-6xl font-serif mb-3 text-[#2a2a2a] leading-tight">
        Mohácsi Andrea
      </h1>
...
<div className="max-w-3xl mb-14 lg:ml-24">
      ...
      <p className="text-2xl leading-[1.8] text-[#3c4343]">
        Integratív szemlélettel dolgozom, amelyben a testi érzetek,
        az érzelmi folyamatok és a belső történetek egyaránt
    ...
    <div className="grid md:grid-cols-2 gap-14 text-lg leading-[2] text-[#3f4444]">
      ...
      <div className="space-y-8">
        <p>
          ...
          biztonság erősítése áll a középpontban. Megtartó,
          elfogadó térben dolgozunk, ahol a teljes ember számít –
          nem csak a nehézség.
        </p>

        <p>
          Azok fordulnak hozzám, akik gyakran „jól működnek”
          a mindennapokban, mégis feszültséget, ürességet vagy
          elakadást élnek meg.
        </p>
      </div>
      ...
      <div className="space-y-8">
        <p>
          A közös munkában fontos számomra a kiszámítható keret,
          az érzelmi biztonság és az együtt gondolkodás.
        </p>

        <p>
          Van, amikor már sok mindent értünk magunkról, mégis nehéz
          a jelenlét, a kapcsolódás a mindennapokban.
        </p>

        <p>
          Ez a tér azoknak szól, akik szeretnének hidat építeni
          önmaguk felé.
        </p>
      </div>
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    <div className="grid md:grid-cols-2 gap-x-20 gap-y-12 max-w-6xl mx-auto">
      ...
      <div className="space-y-10 text-lg leading-[2] text-[#4a4a48]">
        ...
        <p>
          Az integratív szemlélet számomra azt jelenti, hogy
          a belső folyamatokat több nézőpontból, egymással
          összefüggésben vizsgáljuk: érzelmi, testi,
      ...
      <div className="space-y-10 text-lg leading-[2] text-[#4a4a48]">
        ...
        <p>
          Munkámat rendszeres önreflexió, továbbképzés és
          szakmai felelősségvállalás kíséri. Fontos számomra,
          hogy a segítői munka ne technikák alkalmazása legyen,
          hanem egy folyamatosan átgondolt, etikus és
          biztonságos kísérés.
        </p>
